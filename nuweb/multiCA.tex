...
\item \NWtxtIdentsDefed\nobreak\  \verb@.multiCA.test@\nobreak\ \NWlink{nuweb?}{?}\NWlink{nuweb?}{, ?}\NWlink{nuweb?}{, ?}\NWlink{nuweb?}{, ?}\NWlink{nuweb?}{, ?}\NWlink{nuweb?}{, ?}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\mbox{}\verb@#'@{\tt @}\verb@param scores non-decreasing numeric vector of the same length as the number of ordered groups. Defaults to linearly increasing values@\\
...
\mbox{}\verb@#'@{\tt @}\verb@param formula a formula of the form \code{outcome ~ group} where \code{outcome} is a factor representing the categorical outcome and \code{group} is the grouping variable over which the trend is tested.@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Calculate adjusted p-values}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Holm-Shaffer adjustment}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape glht adjustment}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
