...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtFileDefBy\ \NWlink{nuweb2b}{2b}\NWlink{nuweb3}{, 3}\NWlink{nuweb4}{, 4}\NWlink{nuweb7b}{, 7b}\NWlink{nuweb9a}{, 9a}\NWlink{nuweb10}{, 10}\NWlink{nuweb15}{, 15}.
\item \NWtxtIdentsDefed\nobreak\  \verb@.multiCA.test@\nobreak\ \NWlink{nuweb3}{3}\NWlink{nuweb6c}{, 6c}\NWlink{nuweb10}{, 10}\NWlink{nuweb11}{, 11}\NWlink{nuweb13b}{, 13b}\NWlink{nuweb14}{, 14}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb4}{} \verb@"../R/multiCA.R"@\nobreak\ {\footnotesize {4}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@#'@{\tt @}\verb@rdname multiCA.test@\\
...
\NWtarget{nuweb5a}{} \verb@"../tests/testthat/test_overall.R"@\nobreak\ {\footnotesize {5a}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtFileDefBy\ \NWlink{nuweb5a}{5a}\NWlink{nuweb6b}{, 6b}\NWlink{nuweb7a}{, 7a}.
...
\NWtarget{nuweb5b}{} $\langle\,${\itshape Calculate adjusted p-values}\nobreak\ {\footnotesize {5b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb6a}{} $\langle\,${\itshape Holm-Shaffer adjustment}\nobreak\ {\footnotesize {6a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb6c}{} $\langle\,${\itshape Closed set adjustment}\nobreak\ {\footnotesize {6c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb7a}{} \verb@"../tests/testthat/test_overall.R"@\nobreak\ {\footnotesize {7a}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb7b}{} \verb@"../R/multiCA.R"@\nobreak\ {\footnotesize {7b}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb9a}{} \verb@"../R/multiCA.R"@\nobreak\ {\footnotesize {9a}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtFileDefBy\ \NWlink{nuweb2b}{2b}\NWlink{nuweb3}{, 3}\NWlink{nuweb4}{, 4}\NWlink{nuweb7b}{, 7b}\NWlink{nuweb9a}{, 9a}\NWlink{nuweb10}{, 10}\NWlink{nuweb15}{, 15}.
\item \NWtxtIdentsDefed\nobreak\  \verb@cnonct@\nobreak\ \NWlink{nuweb9b}{9b}\NWlink{nuweb10}{, 10}\NWlink{nuweb15}{, 15}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
\begin{flushleft} \small\label{scrap15}\raggedright\small
\NWtarget{nuweb9b}{} \verb@"../tests/testthat/test_power.R"@\nobreak\ {\footnotesize {9b}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtFileDefBy\ \NWlink{nuweb9b}{9b}\NWlink{nuweb11}{, 11}\NWlink{nuweb13b}{, 13b}\NWlink{nuweb14}{, 14}\NWlink{nuweb?}{, ?}\NWlink{nuweb?}{, ?}.
...
\NWtarget{nuweb10}{} \verb@"../R/multiCA.R"@\nobreak\ {\footnotesize {10}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@#' The sample size calculation depends only on \code{p.ave} - the weighted average probability of @\\
\mbox{}\verb@#' each outcome, and \code{slopes} - the weighted regression slope of each outcome.@\\
\mbox{}\verb@#'@\\
\mbox{}\verb@#' The values of these two key inputs can be specified in three ways: @\\
\mbox{}\verb@#'@\\
\mbox{}\verb@#' 1. directly passing \code{p.ave} and  \code{slopes}, or @\\
\mbox{}\verb@#'@\\
\mbox{}\verb@#' 2. specifying exactly two of the parameters \code{p.ave}, \code{slopes}, \code{p.start}, and \code{p.end}. @\\
\mbox{}\verb@#' In this case the full matrix of outcome probabilites will be inferred@\\
\mbox{}\verb@#' assuming linearity within each outcome.@\\
\mbox{}\verb@#'@\\
\mbox{}\verb@#' 3. specifying the full matrix of outcome probabilities \code{pmatrix}.  @\\
\mbox{}\verb@#' @\\
...
\mbox{}\verb@#' against the column \code{scores} with weights \code{n.prop}. The values should add up to zero,@\\
...
\mbox{}\verb@#' @{\tt @}\verb@seealso \code{\link{power.CA.test}} for simpler (and more precise) power calculation @\\
\mbox{}\verb@#' with a binomial outcome @\\
\mbox{}\verb@#' @{\tt @}\verb@references Szabo, A. (2018). Test for Trend With a Multinomial Outcome. The American Statistician, 73(4), 313–320. @\\
\mbox{}\verb@#' @{\tt @}\verb@export@\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtFileDefBy\ \NWlink{nuweb2b}{2b}\NWlink{nuweb3}{, 3}\NWlink{nuweb4}{, 4}\NWlink{nuweb7b}{, 7b}\NWlink{nuweb9a}{, 9a}\NWlink{nuweb10}{, 10}\NWlink{nuweb15}{, 15}.
\item \NWtxtIdentsDefed\nobreak\  \verb@power.multiCA.test@\nobreak\ \NWlink{nuweb11}{11}\NWlink{nuweb13b}{, 13b}\NWlink{nuweb14}{, 14}.\item \NWtxtIdentsUsed\nobreak\  \verb@.multiCA.test@\nobreak\ \NWlink{nuweb2b}{2b}, \verb@cnonct@\nobreak\ \NWlink{nuweb9a}{9a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb12}{} $\langle\,${\itshape Calculate p.ave and slopes from specification}\nobreak\ {\footnotesize {12}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb13a}{} $\langle\,${\itshape Get cbar and s2}\nobreak\ {\footnotesize {13a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb13b}{} \verb@"../tests/testthat/test_power.R"@\nobreak\ {\footnotesize {13b}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb13c}{} $\langle\,${\itshape Check validity of p.ave and slopes}\nobreak\ {\footnotesize {13c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb14}{} \verb@"../tests/testthat/test_power.R"@\nobreak\ {\footnotesize {14}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb15}{} \verb@"../R/multiCA.R"@\nobreak\ {\footnotesize {15}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@#'@\\
\mbox{}\verb@#' # power of a 2-sided test to detect a logistic increase with slope 0.2 over 5 groups@\\
\mbox{}\verb@#' # with groups of size 10 with unequal dose spacing@\\
\mbox{}\verb@#' doses <- c(0,1,2,4,8)@\\
\mbox{}\verb@#' p0 <- 0.05 # event probability at lowest dose@\\
\mbox{}\verb@#' logit.props <- log(p0/(1-p0)) + doses * 0.2@\\
\mbox{}\verb@#' p <- 1 / (1 + exp(-logit.props)) # hypothesized probabilities at each dose@\\
\mbox{}\verb@#' power.CA.test(N = 10 * 5, pvec=p, scores = doses)@\\
\mbox{}\verb@#'@\\
\mbox{}\verb@#' @{\tt @}\verb@export@\\
\mbox{}\verb@#' @{\tt @}\verb@references Nam, J. (1987). A Simple Approximation for Calculating Sample Sizes for Detecting Linear Trend in Proportions.@\\
\mbox{}\verb@#' Biometrics, 43(3), 701-705. @\\
\mbox{}\verb@#' @{\tt @}\verb@importFrom stats pnorm qnorm @\\
\mbox{}\verb@#'@\\
\mbox{}\verb@@\\
\mbox{}\verb@power.CA.test <- function(N=NULL, power=NULL, pvec=NULL, scores=seq_along(pvec), @\\
\mbox{}\verb@                          n.prop=rep(1, length(pvec)), sig.level=0.05,@\\
\mbox{}\verb@                          alternative = c("two.sided", "less", "greater")){@\\
\mbox{}\verb@  if (sum(sapply(list(N, power), is.null)) != 1) @\\
\mbox{}\verb@        stop("exactly one of 'N',  and 'power' must be NULL")@\\
\mbox{}\verb@  if (!is.numeric(sig.level) || any(0 > sig.level | sig.level > 1)) @\\
\mbox{}\verb@        stop("'sig.level' must be numeric in [0, 1]")@\\
\mbox{}\verb@  if (any(pvec < 0) | any(pvec > 1))@\\
\mbox{}\verb@        stop("All probabilities in 'pvec' should be between 0 and 1")@\\
\mbox{}\verb@  if (length(pvec) != length(scores) | length(pvec) != length(n.prop))@\\
\mbox{}\verb@      stop("Vectors 'pvec', 'scores', and 'n.prop', if specified, should have the same lengths.")@\\
\mbox{}\verb@  @\\
\mbox{}\verb@        @\\
\mbox{}\verb@  alternative <- match.arg(alternative)        @\\
\mbox{}\verb@        @\\
\mbox{}\verb@  n.prop <- n.prop / sum(n.prop)@\\
\mbox{}\verb@  @\\
\mbox{}\verb@  @\\
\mbox{}\verb@  sbar <- sum(scores * n.prop)@\\
\mbox{}\verb@  pbar <- sum(pvec * n.prop)@\\
\mbox{}\verb@  v.nu <- sum(n.prop * (scores-sbar)^2)@\\
\mbox{}\verb@  v0 <- pbar * (1-pbar) * v.nu@\\
\mbox{}\verb@  v <- sum(n.prop * pvec * (1-pvec) * (scores-sbar)^2)@\\
\mbox{}\verb@  mu <- sum(n.prop * pvec * (scores - sbar))@\\
\mbox{}\verb@  @\\
\mbox{}\verb@  if (alternative == "two.sided"){@\\
\mbox{}\verb@    crit <- qchisq(sig.level, df=1, lower.tail=FALSE)@\\
\mbox{}\verb@    ncp0 <- mu^2 / v@\\
\mbox{}\verb@  } else {@\\
\mbox{}\verb@    crit <- qnorm(sig.level, lower.tail=FALSE)@\\
\mbox{}\verb@    if (alternative == "less") crit <- (-1) * crit@\\
\mbox{}\verb@  }@\\
\mbox{}\verb@  @\\
\mbox{}\verb@  @\\
\mbox{}\verb@  if (missing(power)){@\\
\mbox{}\verb@    if (alternative == "two.sided"){@\\
\mbox{}\verb@      ncp <- ncp0 * N@\\
\mbox{}\verb@      power <- pchisq(v0/v * crit, df=1, ncp=ncp, lower.tail=FALSE)@\\
\mbox{}\verb@    } else {@\\
\mbox{}\verb@      term <- (sqrt(v0)*crit - mu * sqrt(N)) / sqrt(v)@\\
\mbox{}\verb@      power <- pnorm(term, lower.tail = (alternative == "less"))@\\
\mbox{}\verb@    }@\\
\mbox{}\verb@   } @\\
\mbox{}\verb@   else {@\\
\mbox{}\verb@    if (alternative == "two.sided"){@\\
\mbox{}\verb@      ncp <- cnonct(v0/v *crit, p=1-power, df=1)@\\
\mbox{}\verb@      N <-  ncp / ncp0@\\
\mbox{}\verb@    } else {@\\
\mbox{}\verb@      zb <- qnorm(power, lower.tail=TRUE)@\\
\mbox{}\verb@      N <- (sqrt(v0) * crit + sqrt(v) * zb)^2 / mu^2@\\
\mbox{}\verb@    }@\\
\mbox{}\verb@   }@\\
\mbox{}\verb@@\\
\mbox{}\verb@   res <- structure(list(n = N, n.prop = n.prop, p = pvec, @\\
\mbox{}\verb@                        alternative = alternative,  @\\
\mbox{}\verb@                        sig.level = sig.level, power = power,  @\\
\mbox{}\verb@                         method = "Cochran-Armitage trend test"), @\\
\mbox{}\verb@                     class = "power.htest")@\\
\mbox{}\verb@   res@\\
\mbox{}\verb@   }@\\
\mbox{}\verb@        @\\
...
\item \verb@"../R/multiCA.R"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb2b}{2b}\NWlink{nuweb3}{, 3}\NWlink{nuweb4}{, 4}\NWlink{nuweb7b}{, 7b}\NWlink{nuweb9a}{, 9a}\NWlink{nuweb10}{, 10}\NWlink{nuweb15}{, 15}.
}
\item \verb@"../tests/testthat/test_overall.R"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb5a}{5a}\NWlink{nuweb6b}{, 6b}\NWlink{nuweb7a}{, 7a}.
}
\item \verb@"../tests/testthat/test_power.R"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb9b}{9b}\NWlink{nuweb11}{, 11}\NWlink{nuweb13b}{, 13b}\NWlink{nuweb14}{, 14}\NWlink{nuweb?}{, ?}\NWlink{nuweb?}{, ?}.
}
\end{list}}
...
\item $\langle\,$Calculate p.ave and slopes from specification\nobreak\ {\footnotesize \NWlink{nuweb12}{12}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb10}{10}.}
\item $\langle\,$Check validity of p.ave and slopes\nobreak\ {\footnotesize \NWlink{nuweb13c}{13c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb12}{12}.}
\item $\langle\,$Closed set adjustment\nobreak\ {\footnotesize \NWlink{nuweb6c}{6c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb5b}{5b}.}
\item $\langle\,$Get cbar and s2\nobreak\ {\footnotesize \NWlink{nuweb13a}{13a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb12}{12}.}
\item $\langle\,$glht adjustment\nobreak\ {\footnotesize \NWlink{nuweb8a}{8a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb5b}{5b}.}
\item $\langle\,$Holm-Shaffer adjustment\nobreak\ {\footnotesize \NWlink{nuweb6a}{6a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb5b}{5b}.}
\end{list}}
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@.multiCA.test@: \underline{\NWlink{nuweb2b}{2b}}\NWlink{nuweb3}{, 3}\NWlink{nuweb6c}{, 6c}\NWlink{nuweb10}{, 10}\NWlink{nuweb11}{, 11}\NWlink{nuweb13b}{, 13b}\NWlink{nuweb14}{, 14}.
\item \verb@cnonct@: \underline{\NWlink{nuweb9a}{9a}}\NWlink{nuweb9b}{, 9b}\NWlink{nuweb10}{, 10}\NWlink{nuweb15}{, 15}.
\item \verb@multiCA.test.default@: \underline{\NWlink{nuweb3}{3}}.
\item \verb@multiCA.test.formula@: \underline{\NWlink{nuweb4}{4}}.
\item \verb@power.multiCA.test@: \underline{\NWlink{nuweb10}{10}}\NWlink{nuweb11}{, 11}\NWlink{nuweb13b}{, 13b}\NWlink{nuweb14}{, 14}.
\end{list}}
