...
\mbox{}\verb@#' The distribution of the outcomes can be specified in two ways: @\\
\mbox{}\verb@#'@\\
\mbox{}\verb@#' 1. the full matrix of outcome probabilities \code{pmatrix} can be specified, or @\\
\mbox{}\verb@#'@\\
\mbox{}\verb@#' 2. exactly two of the parameters \code{p.ave}, \code{slopes}, \code{p.start}, and \code{p.end} @\\
\mbox{}\verb@#' can be specified. In this case the full matrix of outcome probabilites will be inferred@\\
...
\mbox{}\verb@#' against the column \code{scores} with weights \code{n.prop}@\\
...
\mbox{}\verb@  ncp0 <-  sum(n.prop * pvec * (scores - sbar))^2 / v@\\
\mbox{}\verb@  @\\
\mbox{}\verb@  if (missing(power)){@\\
\mbox{}\verb@    ncp <- ncp0 * N@\\
...
\mbox{}\verb@   } @\\
\mbox{}\verb@   else {@\\
\mbox{}\verb@     ncp <- cnonct(v0/v *crit, p=1-power, df=df)@\\
\mbox{}\verb@     N <-  ncp / ncp0@\\
\mbox{}\verb@   }@\\
\mbox{}\verb@@\\
\mbox{}\verb@   res <- structure(list(n = N, n.prop = n.prop, sig.level = sig.level, power = power,  @\\
